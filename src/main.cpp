...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime)
{
    ...
    
	{
        ...
        // CryptoBuck: reward for coin-year is cut in half every 64x multiply of PoS difficulty
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fStrictPayToScriptHash = true; // Always active in CryptoBuck
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CryptoBuck - Valued more than a coin!";
        CTransaction txNew;
		...
		txNew.strTxComment = "text: CryptoBuck genesis block";
        ...
        assert(block.hashMerkleRoot == uint256("0xb2de3c216b4f82bfeca59ae4a1824e4c5ba2e83672b42aa96e00b0024cb58269"));
